  ...
  return (
    <Section id="about-us">
        <div className="container relative z-2">
            ...
            <Heading className="md:max-w-md lg:max-w-2xl" title="IT-gondjaidra nálunk mindig van egy biztos válasz" />
                ...
                <div key={item.id} className="block relative p-0.5 bg-no-repeat bg-[length:100%_100%] md:max-w-[24rem]" style={{backgroundImage: `url(${item.backgroundUrl})`}}>
                    <div className="relative z-2 flex flex-col min-h-[22rem] p-[2.4rem] pointer-events-none max-md:max-w-[352px]">
                        ...
                        <div className="flex items-center mt-auto">
                            ...
                            <p className="ml-auto font-code text-xs font-bold text-n-1 uppercase tracking-wider">Fedezd fel</p>
                            <Arrow />
                        </div>
                    </div>
