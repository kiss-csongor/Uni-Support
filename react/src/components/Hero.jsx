...
const Hero = () => {
  ...
  return (
    <>
    <Section
      className="pt-[6rem] -mt-[5.25] pb-20 over"
      crosses
    ...
    >
      <div className="container relative" ref={parallaxRef}>
          ...
          <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
            <div className="relative bg-n-8 rounded-[1rem]">
              ...
              <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/690]">
                <img
                  src={hero}
                  className="w-full scale-[1.7] md:scale-[1] md:translate-y-[-10%] lg:-translate-y-[13%] lg-scale-[1.2] max-md:-translate-y-[-9%]"
                  width={1024}
                  height={490}
                />
        ...
        <CompanyLogos className="hidden relative z-10 mt-20 md:block center" />
      </div>
      <BottomLine />
    </Section>
    </>
